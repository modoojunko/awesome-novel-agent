...
本项目的短篇写作流程由 6 个 agent 协作完成，定义在 `.codex/agents/` 下（TOML 格式）。

**开始写作：** 在 Codex 中通过 `@short-agent` 或 `spawn_agent` 调用 short-agent 进入写作循环，或直接说「帮我写个短篇」。
...
- `.codex/agents/` — 各 agent 定义（TOML）
- `.codex/knowledge/` — 短篇去AI口径、短篇格式规范、短篇写作参考、题材风格包
