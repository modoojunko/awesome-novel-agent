...
- **Loop Integration:**
  ...
  STEP 3 — ⚠️ 展示方案给作者拍板（对作者全文用日常语言，遵循 `.claude/knowledge/author-communication.md`；不展示"情绪走向/冲突阶梯/信息差/主导驱动力/钩子操作"等内部小标题）：
    ① 展示作者友好版方案：
       ```
       ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
         第{N}卷 方案预览
       ...
       读者情绪怎么走：{完整弧线，附每个情绪段对应哪几章}
       冲突怎么升级：{第1层…→第4层…，每层哪几章}
       谁知道什么、谁不知道什么：{卷起点→终点信息变化一句话}
